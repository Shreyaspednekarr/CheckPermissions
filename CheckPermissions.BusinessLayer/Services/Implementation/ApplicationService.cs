...
namespace CheckPermissions.BusinessLayer.Services.Implementation
{
    public class ApplicationService(IUnitOfWork unitOfWork) : IApplicationService
    {
        ...
        {
            return await _unitOfWork.Application.IsExists(request).ConfigureAwait(false);
        }
        ...
        {
            return await _unitOfWork.Application.Delete(applicationId).ConfigureAwait(false);
        }
    }
}
